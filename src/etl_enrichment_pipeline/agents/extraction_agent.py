...
def extract_postgres_schema(creds: dict, rules: dict) -> dict:
    ...
    -------
    dict
        Matches the format in raw_metadata.json with tables, columns, constraints,
        and relationships.
    """
    pg_creds = creds.copy()
...
def main() -> None:
    ...
    for db in ALL_DATABASES:
        ...
        try:
            if db_type == "postgres":
                ...
                print(
                    f"[OK] Postgres Extraction for {db_name} saved to {output_path}.\n"
                )
    ...
    print("=======================================")
    print("*** PIPELINE FINISHED. Database extractions saved to 'sqlj_son/'.")
    print("=======================================")
